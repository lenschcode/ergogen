	...
	(module Button_Switch_SMD:SW_SPST_B3U-1000P (layer F.Cu) (tedit 5A02FC95)
	  ...
	  (fp_text user %R (at 0 -2.5) (layer F.Fab)
	    ...
	    function pins(def_neg, def_pos, def_side) {
		  return `
		    ${''/* pins */}
	  (pad 1 smd rect (at ${def_neg}1.7 0) (size 0.9 1.7) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) ${p.from.str})
	  (pad 2 smd rect (at ${def_pos}1.7 0) (size 0.9 1.7) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) ${p.to.str})
		  `
	    }
	    if(p.reversible) {
	      return `
